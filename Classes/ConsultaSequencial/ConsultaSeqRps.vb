...
Namespace ConsultaSequencial
    ...
    <XmlRoot("ConsultaSeqRps", Namespace:="http://localhost:8080/WsNFe2/lote")> _
    Public Class ConsultaSeqRps
        Private _cabecalho As Cabecalho
        Private _schemaLocation As String = "http://localhost:8080/WsNFe2/lote http://localhost:8080/WsNFe2/xsd/ConsultaSeqRps.xsd"
